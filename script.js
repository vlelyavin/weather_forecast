...
var _this = this;
var weatherNow = function (city) { return __awaiter(_this, void 0, void 0, function () {
    var appId, weather, forecast, resultDaily, resultHourly, dataHourly, dataDaily, currentDate, currentDay, dayNames, currentDayFull, monthNames, currentMonthFull, location, date, temp, weatherType, highest, lowest, wind, sunrise, sunset, humidity, icon, body, sunsetDate, sunriseDate, cardsTime, cardTimeCalc, cardsIcon, cardIconCalc, cardsTemp, cardTempCalc;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                appId = "d35b71595a40920a3df089572ef115d9";
                weather = "https://api.openweathermap.org/data/2.5/forecast?q=".concat(city, "&appid=").concat(appId, "&units=metric");
                forecast = "https://api.openweathermap.org/data/2.5/weather?q=".concat(city, "&appid=").concat(appId, "&units=metric");
